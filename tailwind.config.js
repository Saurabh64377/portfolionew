  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'radial-gradient(ellipse 80% 80% at 50% -20%, rgba(108,99,255,0.3) 0%, transparent 60%)',
        'gradient-card': 'linear-gradient(135deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.01) 100%)',
        'gradient-accent': 'linear-gradient(135deg, #6c63ff 0%, #a855f7 50%, #ec4899 100%)',
      ...
      boxShadow: {
        ...
        'glow-green': '0 0 40px rgba(67,233,123,0.4)',
        'glow-pink': '0 0 40px rgba(255,101,132,0.4)',
